...
<blockquote class="layui-elem-quote">
    <form action="/menu/loadAllMenu" method="post" id="dataForm" lay-filter="dataForm" class="layui-form layui-form-pane">
...
<div>
    ...
    <div id="menuToolBar" style="display: none">
        <button type="button" lay-event="add" shiro:hasPermission="menu:create" class="layui-btn layui-btn-sm"><span class="layui-icon layui-icon-add-1"></span>添加</button>
    </div>
    <div id="menuRowBar" style="display: none">
        <button type="button" lay-event="update" shiro:hasPermission="menu:update" class="layui-btn layui-btn-sm layui-btn-warm"><span class="layui-icon layui-icon-edit"></span>修改</button>
