...
<blockquote class="layui-elem-quote">
    <form action="/loginfo/loadAllLoginfo" method="post" id="dataForm" lay-filter="dataForm" class="layui-form layui-form-pane">
...
<div>
    ...
    <div id="loginfoRowBar" style="display: none">
        <button type="button" lay-event="deleteLoinfo" shiro:hasPermission="info:delete" class="layui-btn layui-btn-sm layui-btn-danger"><span class="layui-icon layui-icon-delete"></span>删除</button>
    </div>
